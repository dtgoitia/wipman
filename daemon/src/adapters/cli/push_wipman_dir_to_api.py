...
from daemon.src.use_cases.push_wipman_dir_to_api import push_wipman_dir_to_api
...
def push_wipman_dir_to_api_cmd(
    ...
    push_wipman_dir_to_api(config=config)
